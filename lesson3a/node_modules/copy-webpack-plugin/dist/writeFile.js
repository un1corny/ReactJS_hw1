...
function writeFile(globalRef, pattern, file) {
    ...
    return (0, _pify2.default)(inputFileSystem).stat(file.absoluteFrom).then(function (stat) {
        ...
        return (0, _pify2.default)(inputFileSystem).readFile(file.absoluteFrom).then(function (content) {
