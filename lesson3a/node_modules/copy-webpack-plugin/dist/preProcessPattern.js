...
function preProcessPattern(globalRef, pattern) {
    ...
    if ((0, _isObject2.default)(pattern.from) && pattern.from.glob) {
        ...
        pattern.absoluteFrom = (0, _escape2.default)(pattern.context, pattern.from.glob);
    ...
    return (0, _pify2.default)(inputFileSystem).stat(pattern.absoluteFrom).catch(function () {
        // If from doesn't appear to be a glob, then log a warning
        if ((0, _isGlob2.default)(pattern.from) || pattern.from.indexOf('*') !== -1) {
            pattern.fromType = 'glob';
            pattern.absoluteFrom = (0, _escape2.default)(pattern.context, pattern.from);
        } else {
        ...
        if (stat.isDirectory()) {
            ...
            pattern.absoluteFrom = (0, _escape2.default)(pattern.absoluteFrom, '**/*');
            pattern.fromArgs = {
                dot: true
            };
        } else if (stat.isFile()) {
