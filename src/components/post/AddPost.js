        ...
        return <div>
            ...
            <form action='#' id='addPostForm'>
                ...
                <div className="form-group">
                    ...
                    <input type="text" className='form-control' id='postTitle' placeholder='post header'
                           defaultValue={'post totle'}/>
                </div>
                <div className="form-group">
                    <label htmlFor="postText">Текст поста</label>
                    <input type="text" className='form-control' id='postText' placeholder='your post'
